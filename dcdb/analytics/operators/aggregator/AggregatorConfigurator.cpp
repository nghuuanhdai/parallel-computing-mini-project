...
AggregatorConfigurator::AggregatorConfigurator() : OperatorConfiguratorTemplate() {
...
void AggregatorConfigurator::operatorAttributes(AggregatorOperator& op, CFG_VAL config) {
        BOOST_FOREACH(boost::property_tree::iptree::value_type &val, config)
        {
