 ...
 * @ingroup filesink
 */
class FilesinkConfigurator : virtual public OperatorConfiguratorTemplate<FilesinkOperator, FilesinkSensorBase> {
...
private:
    ...
    void operatorAttributes(FilesinkOperator& op, CFG_VAL config) override;
